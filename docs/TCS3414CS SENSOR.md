...
## Key Details about the TCS34725CS Sensor
...
- **Documentation:** [TCS34725CS Documentation](https://wiki.seeedstudio.com/Grove-SHT4x/)
...
<img src="/images/write.png" alt="Grove TCS34725CS" width="1000">

After sending the command, we can read the temperature and humidity. We need to use a formula to convert each value correctly. Refer to the documentation [TCS34725CS Documentation](https://wiki.seeedstudio.com/Grove-SHT4x/) for more details.
